		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="row col-xs-12" style="margin-top: 8px;">
					<form action="/SSM/addNewData" method="post">
					<table>
						<tr>
							<td width="80">
								<div class="form-group has-feedback">
									<p class="text-right">年月日&nbsp;&nbsp;</p>
								</div>
							</td>
							<td>
								<div class="form-group has-feedback jeinpbox">
									<input type="text" id="time" name="dateD" class="form-control jeinput"
										placeholder="08-15-2018">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group has-feedback">
									<input type="text" class="form-control widget-user-2"
										id="gotime" name="createdateD" placeholder="08-15-2018"
									...
									<input type="text" name="weekD" class="form-control widget-user-2"
						...
						<tr>
							...
							<td>
								<div class="form-group has-feedback">
									<input type="text" name="classtype" class="form-control" >
								</div>
							</td>
						</tr>
						<tr>
							<td>
								<div class="form-group has-feedback">
									<p class="text-right">是否补课&nbsp;&nbsp;</p>
								</div>
							</td>
							<td>
								<div class="form-group has-feedback">
									<input type="radio" name="status">周末&nbsp;&nbsp; <input
										type="radio" name="status">晚间
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<div class="form-group has-feedback">
									<p class="text-right">课程内容&nbsp;&nbsp;</p>
								</div>
							</td>
							<td>
								<div class="form-group has-feedback">
									<input type="text" name="classcontent" class="form-control" >
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group has-feedback">
									<input type="text" name="classconversion" class="form-control" >
								</div>
							</td>
						</tr>
						<tr>
